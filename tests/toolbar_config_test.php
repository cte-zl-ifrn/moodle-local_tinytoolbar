...
/**
 * PHPUnit tests for local_tinytoolbar\toolbar_config.
 *
 ...
 *
 * @covers \local_tinytoolbar\toolbar_config
 */
class toolbar_config_test extends advanced_testcase {
    ...
    public function test_get_active_config_disabled(): void {
        set_config('enable_plugin', 0, 'local_tinytoolbar');
    ...
    public function test_get_active_config_preset(): void {
        set_config('enable_plugin', 1, 'local_tinytoolbar');
        set_config('active_preset', toolbar_config::PRESET_MINIMAL, 'local_tinytoolbar');
    ...
    public function test_get_active_config_custom(): void {
        ...
        set_config('enable_plugin', 1, 'local_tinytoolbar');
        set_config('active_preset', toolbar_config::PRESET_CUSTOM, 'local_tinytoolbar');
        set_config('toolbar_json', $customJson, 'local_tinytoolbar');
    ...
    public function test_tiny_get_config_data(): void {
        set_config('enable_plugin', 1, 'local_tinytoolbar');
        set_config('active_preset', toolbar_config::PRESET_CLASSIC, 'local_tinytoolbar');
