...
/**
 * Privacy API implementation for tool_tinycustomizer.
 *
...
namespace tool_tinycustomizer\privacy;

use core_privacy\local\metadata\collection;

/**
 * The tool_tinycustomizer plugin does not store any personal user data.
 */
